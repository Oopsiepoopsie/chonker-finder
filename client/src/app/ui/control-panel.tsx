...
export const ControlPanel = ({
  ...
  return (
    <div className="absolute top-20 right-20 w-64 bg-white p-3 shadow-md cursor-auto text-sm leading-tight box-border outline-none focus:outline-black mobile-bottom">
